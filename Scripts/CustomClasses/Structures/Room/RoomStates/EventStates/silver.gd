extends State
class_name RoomSilverEventState
...
var monster_type:String = "Strong"

var monster_damage:int = 20

var monster_memoria_loot = 40

var memoria_cost:int = 10

#region DIALOGUES

var enemy_encounter: String = "You have encountered a " + monster_type + " enemy!"

var flavor_encounter_text:String = "Godspeed!"
...
func trigger_event():
	...
	state_owner.event_presenter("res://Assests/Art/Events/Silver/Silver_Encounter.png")
