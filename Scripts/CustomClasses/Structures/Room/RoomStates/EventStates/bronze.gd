extends State
class_name RoomBronzeEventState
...
var monster_type:String = "Regular"

var monster_damage:int = 10

var monster_memoria_loot = 20

var memoria_cost:int = 2
...
func trigger_event():
	...
	state_owner.event_presenter("res://Assests/Art/Events/Bronze/Bronze_Encounter.png")
